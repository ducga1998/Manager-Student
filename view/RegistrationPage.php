        ...
        <div class="container__child signup__form">
            <form action="../index.php">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="usernameDK" id="username" placeholder="james.bond" required />
                </div>
                <div class="form-group">
                    <label for="email">Email</label>
                    <input class="form-control" type="text" name="emailDK" id="email" placeholder="james.bond@spectre.com" required />
                </div>
                <div class="form-group">
                    <label for="password">Password</label>
                    <input class="form-control" type="password" name="passwordDK" id="password" placeholder="********" required />
                </div>
                <div class="form-group">
                    <label for="passwordRepeat">Number Phone</label>
                    <input class="form-control" type="text" name="NumberPhoneDK" placeholder="Number Phone" required />
                </div>
                <div class="form-group">
                    <label for="passwordRepeat">Country Your </label>
                    <input class="form-control" type="text" name="CountryDK" id="Country" placeholder="Country Your" required />
                </div>
                <div class="form-group">
                    <label for="passwordRepeat">Repeat Password</label>
                    <input class="form-control" type="password" id="passwordRepeat" placeholder="********" required />
                </div>
                <div class="m-t-lg">
