    ...
    <div class="cont">
        <form action="./index.php" id="FormLogin" method="post">
            ...
            <path d="M0,20 a10,8 0 0,1 20,0z M10,0 a4,4 0 0,1 0,8 a4,4 0 0,1 0,-8" />
                            ...
                            <input name="email" type="text" class="login__input name" placeholder="Username" />
                        </div>
                        <div class="login__row">
                            <svg class="login__icon pass svg-icon" viewBox="0 0 20 20">
            <path d="M0,20 20,20 20,8 0,8z M10,13 10,16z M4,8 a6,8 0 0,1 12,0" />
          </svg>
                            <input name="pwd" type="password" class="login__input pass" placeholder="Password" />
                        </div>
                        <input type="button" class="login__submit" value="Sign Up">
                        <p class="login__signup">Don't have an account? &nbsp;<a href="./index.php/?actionBtn=registration">Creat Accout</a></p>
                    </div>
                </div>
                <div class="app">
                    <div class="app__top">
